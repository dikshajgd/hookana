 ...
 * (app/(site)/page.tsx) and the inline site editor (app/admin/site). Kept as a
 * plain server component: the public site renders it with no editor context (so
 * the editable primitives inside each component are transparent), while the
 * editor route renders the very same tree inside an <EditorProvider editing>.
 * One source of truth — the editor and the live page can never drift.
 */
  ...
  return (
    ...
    <div className="w-full overflow-x-clip">
      ...
      <div className="flex flex-col">
        <Problems tabs={settings.problems?.tabs ?? []} />
